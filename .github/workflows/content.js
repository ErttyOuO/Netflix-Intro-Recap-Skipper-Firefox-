// copied from Resources/content.js
const skipButtons = () => {
  const targets = [
    { selector: 'button[data-uia="player-skip-intro"]', message: '已略過開場！🍿' },
    { selector: 'button[data-uia="player-skip-recap"]', message: '已略過前情提要！🕵️‍♂️' }
  ];
